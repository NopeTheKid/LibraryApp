...
public class TopsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        GridView gridview = (GridView) binding.gridview2;
        GridView gridview2 = (GridView) binding.gridview1;
        ...
        gridview.setAdapter(new GidViewAdapter(getContext(), bookList));
        gridview2.setAdapter(new GidViewAdapter(getContext(), bookList));
